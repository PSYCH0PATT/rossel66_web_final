...
export default function DataRFFormPage() {
  ...
  return (
    ...
    >
      <Navbar />
      <div className="flex-grow pt-20 pb-12 md:pt-24 md:pb-16">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6">
          ...
          <form
            ...
            className="max-w-6xl mx-auto bg-black/30 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-2xl relative z-[1]"
            style={{
              borderWidth: '1px',
              borderStyle: 'solid',
