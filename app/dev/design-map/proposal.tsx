    ...
    <div id="proposal" className="scroll-mt-4 space-y-6 rounded-2xl border border-status-success/25 bg-status-success/[0.02] p-4 md:p-6">
      ...
      <div className="space-y-6">
        ...
        <Dim
          ...
          why={
            <>
              ...
              больше нужен радиус. Каждая ступень уже доминирует в своём классе — 54 кнопки из 61 уже{" "}
              <Mono>rounded-lg</Mono>, 61 карточка из 65 уже <Mono>rounded-2xl</Mono>. Канон только запрещает хвост.
            </>
          }
          price="~80 правок в ~35 файлах, из них 54 — удаление класса, ставшего мёртвым после правки ui/button"
        />
        ...
        <Dim
          ...
          price="~28 правок в ~11 файлах; 11 из них — просто удаление класса поверх card-glass"
        />
        ...
        <Dim
          ...
          price="~21 замена в 25 файлах + ~10 новых loading.tsx + 1 компонент; в статике визуально ноль — стенд снимает загруженные экраны"
        />
        ...
        <Dim
          ...
          price="~260 правок в ~60 файлах — самое дорогое измерение; идёт последней волной, отдельно от всего"
        />
