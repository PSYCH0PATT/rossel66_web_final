...
- **Связь односторонняя.** Главный входит в кабинеты своих профилей, обратно — нет.
...
**Одна команда — `pnpm verify`** (≈90 секунд): типы, линт, юниты, тесты питон-парсера, миграции
...
|---|---|---|---|
| юниты | 163 | `pnpm test` (`npx tsx --test`) | чистые функции: `advance`, `artist-links`, `report-sort`, формы, Buildin, форматирование |
| питон | 23 | `pnpm test:python` (unittest) | группировка AKA, доли роялти, нераспознанные строки, сквозной `process_file` |
