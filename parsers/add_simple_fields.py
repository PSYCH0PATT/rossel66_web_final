#!/usr/bin/env python3
"""
Добавление только 4 полей в профили артистов
"""

import json
from datetime import datetime

def add_simple_fields():
    """Добавляет только нужные поля в профили артистов"""
    ...
    for user in users:
        if user.get('role') == 'artist':
            ...
            if artist_name in artists_data:
                ...
                updated_count += 1
                print(f"✅ Добавлены поля артисту: {artist_name}")
    ...
    print(f"""
🎉 Добавлены поля в профили артистов!
📊 Статистика:
