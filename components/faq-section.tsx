...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Мы предлагаем прозрачную систему распределения доходов. Процент отчислений зависит от типа контракта и объема предоставляемых услуг. Все детали фиксируются в договоре, и вы всегда будете получать регулярные отчёты о прослушиваниях и доходах. Наша цель — построить долгосрочные и взаимовыгодные отношения с артистами.",
  },
  {
    id: 5,
